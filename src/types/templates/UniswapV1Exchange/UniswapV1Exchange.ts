...
export class UniswapV1Exchange__removeLiquidityResult {
  value0: BigInt;
  value1: BigInt;
...
export class UniswapV1Exchange extends SmartContract {
  static bind(address: Address): UniswapV1Exchange {
    return new UniswapV1Exchange("UniswapV1Exchange", address);
  }
  ...
  removeLiquidity(
    ...
    min_tokens: BigInt,
    deadline: BigInt
  ): UniswapV1Exchange__removeLiquidityResult {
    ...
    return new UniswapV1Exchange__removeLiquidityResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_removeLiquidity(
    ...
    min_tokens: BigInt,
    deadline: BigInt
  ): CallResult<UniswapV1Exchange__removeLiquidityResult> {
    ...
    return CallResult.fromValue(
      new UniswapV1Exchange__removeLiquidityResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  transferFrom(_from: Address, _to: Address, value: BigInt): boolean {
